...
const createSubjects = (prices: number[]): Subject[] => [
  ...
  { id: "pediatrics", name: "Pediatrics", icon: "👶", price: prices[12], description: "Child health & development" },
  { id: "obgyn", name: "Obstetrics & Gynecology", icon: "🤰", price: prices[13], description: "Women's health & childbirth" },
  { id: "orthopedics", name: "Orthopedics", icon: "🦿", price: prices[14], description: "Musculoskeletal system" },
  { id: "radiology", name: "Radiology", icon: "☢️", price: prices[15], description: "Medical imaging & diagnostics" },
  { id: "dermatology", name: "Dermatology", icon: "🧴", price: prices[16], description: "Skin conditions & treatments" },
  { id: "psychiatry", name: "Psychiatry", icon: "🧠", price: prices[17], description: "Mental health & disorders" },
  { id: "anesthesia", name: "Anesthesia", icon: "💉", price: prices[18], description: "Anesthetics & pain management" },
];
...
export const coachings: Coaching[] = [
  {
    ...
    subjects: createSubjects([299, 349, 299, 399, 349, 299, 249, 249, 249, 299, 449, 449, 349, 399, 349, 299, 299, 299, 299]),
  },
  {
    id: "prepladder",
    name: "PrepLadder",
    ...
    subjects: createSubjects([279, 329, 279, 379, 329, 279, 229, 229, 229, 279, 429, 429, 329, 379, 329, 279, 279, 279, 279]),
  },
  {
    id: "btr",
    name: "BTR",
    ...
    subjects: createSubjects([259, 309, 259, 359, 309, 259, 209, 209, 209, 259, 409, 409, 309, 359, 309, 259, 259, 259, 259]),
  },
  {
    id: "egurukul",
    name: "eGurukul",
    ...
    subjects: createSubjects([249, 299, 249, 349, 299, 249, 199, 199, 199, 249, 399, 399, 299, 349, 299, 249, 249, 249, 249]),
  },
  {
    id: "marrow6",
    name: "Marrow 6.0",
    ...
    subjects: createSubjects([349, 399, 349, 449, 399, 349, 299, 299, 299, 349, 499, 499, 399, 449, 399, 349, 349, 349, 349]),
  },
  {
    id: "cerebellum",
    name: "Cerebellum",
    ...
    subjects: createSubjects([269, 319, 269, 369, 319, 269, 219, 219, 219, 269, 419, 419, 319, 369, 319, 269, 269, 269, 269]),
  },
];
